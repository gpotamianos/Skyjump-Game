...
/*εδω δημιουργουμε τα ορια του παιχνιδιου δεξια, αριστερα και κάτω ωστε να μην βγαινει εκτός ο παικτης*/
...
void Boundary::init()
{
	...
	//φτιαχνουμε εναν αορατο τοιχο για να παιζει μεσα σε ορια ο παικτης
	for (int i = 0; i < 55; i++) {
		if (i < 10) {
			m_blockster.push_back(Box(x_coor, y_coor, 1.0f, 1.0f));
		...
		y_coor_left -= 1;
		m_blocksterside.push_back(Box(x_coor_right, y_coor_right, 1.0f, 1.0f));
		m_blockterside_names.push_back("invisible-png1.png");
		y_coor_right -= 1;
